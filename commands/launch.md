---
name: afc:launch
description: "Generate release artifacts — use when the user asks to prepare a release, generate changelog, bump version, publish a package, or create release tags"
